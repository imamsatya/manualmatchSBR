<template>
    <div class="about">
        <Toast />
        <br><br>
        <img src="../assets/bps.svg" class="hvr-bob mybob p-mt-1 " style="width: 10%; height: 18%;" alt="" srcset="">
        <div class="p-col-12 p-lg-12   p-grid p-d-flex p-jc-center p-ai-center ">
            ...
            <Card @mouseover="myShadow = ''" @mouseleave="myShadow = ''"
                ...
                <template #content>
                    <div class=" ">
                        <!-- {{classFormModel}} -->
                        <!-- {{classFormModel['subjectMatter']}}
                        <br>
                        {{this.selectedTahun.length}}
                        <br><br>
                        <div v-for="myKey in Object.keys(this.formModel)" :key="myKey">
                            {{myKey}} : {{formModel[myKey]}} <br>
                        </div> -->
                        <div class="p-fluid ">
                            ...
                            <!-- <div class="p-field p-mb-4">
                                <span class="p-float-label">
                                    <InputText v-model="formModel.subjectMatter" placeholder="Nama Fungsi"
                                        id="subject_matter" type="text" :class="classFormModel.subjectMatter" />
                                    <label for="nama_kegiatan">Nama Fungsi</label>
                                </span>
                            </div> -->
                            <div class="p-field p-mb-4">
...
<script>
    ...
    export default {
        ...
        watch: {
            selectedTahun(newValue, oldValue) {
            ...
            validate() {
                if (this.formModel.subjectMatter !== null &&
                    ...
                    if (this.selectedTahun.length > 0) {
                        if (this.tahun2020Display && this.tahun2021Display) {
                            if (
                                ...
                                Object.keys(this.classFormModel).forEach(element => {
                                    this.formModel[element] == null ? this.classFormModel[element] =
                                        'p-invalid' :
                                        this
                        ...
                        Object.keys(this.classFormModel).forEach(element => {
                            this.formModel[element] == null ? this.classFormModel[element] = 'p-invalid' : this
                                .classFormModel[element] = ''
                        });
                        return false
                    }
