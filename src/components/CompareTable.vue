<template>
    <div>
        ...
        <DataTable v-if="this.selectedSumber2 !== null" :value="myData" rowGroupMode="subheader"
            ...
            <Column v-for="col of Object.keys(this.myData[0])" :field="col"
            ...
            <template :class="myCardBgColorData+' '+myTextColorData" #groupfooter="slotProps">
                ...
                <!-- {{this.data1View.slice(slotProps.index-1,slotProps.index+1 )}} -->
                <!-- <td> {{Object.keys(this
                .myData[0]).length}} </td> -->
                <td></td>
                ...
                <!-- <td :class="myCardBgColorData+' '+myTextColorData+' '">
                    <Dropdown :class="myCardBgColorData+' '+myTextColorData+' '"
                        @click="dropDownOptions(slotProps.index)" @change="selectData(slotProps, 0)"
                        v-model="selectedSumber2[slotProps.index-((slotProps.index+1)/2)][0]"
                        :options="options[slotProps.index-((slotProps.index+1)/2)]" optionLabel="name"
                ...
                <td :class="myCardBgColorData+' '+myTextColorData+' '">
                    ...
                    <Dropdown :class="myCardBgColorData+' '+myTextColorData+' '"
                        @click="dropDownOptions(slotProps.index)" @change="selectData(slotProps, 2)"
                        v-model="selectedSumber2[slotProps.index-((slotProps.index+1)/2)][2]"
                        :options="options[slotProps.index-((slotProps.index+1)/2)]" optionLabel="name"
                        placeholder="Pilih Sumber" />
                </td>
                <td :class="myCardBgColorData+' '+myTextColorData+' '">
                    <Dropdown :class="myCardBgColorData+' '+myTextColorData+' '" @change="selectData(slotProps, 3)"
                        @click="dropDownOptions(slotProps.index)"
                        v-model="selectedSumber2[slotProps.index-((slotProps.index+1)/2)][3]"
                        :options="options[slotProps.index-((slotProps.index+1)/2)]" optionLabel="name"
                        placeholder="Pilih Sumber" />
                </td>

                <td :class="myCardBgColorData+' '+myTextColorData+' '">
                    <Dropdown :class="myCardBgColorData+' '+myTextColorData+' '" @change="selectData(slotProps, 4)"
                        @click="dropDownOptions(slotProps.index)"
                        v-model="selectedSumber2[slotProps.index-((slotProps.index+1)/2)][4]"
                        :options="options[slotProps.index-((slotProps.index+1)/2)]" optionLabel="name"
                        placeholder="Pilih Sumber" />
                </td>

                <td :class="myCardBgColorData+' '+myTextColorData+' '">
                    <Dropdown :class="myCardBgColorData+' '+myTextColorData+' '" @change="selectData(slotProps, 5)"
                        @click="dropDownOptions(slotProps.index)"
                        v-model="selectedSumber2[slotProps.index-((slotProps.index+1)/2)][5]"
                        :options="options[slotProps.index-((slotProps.index+1)/2)]" optionLabel="name"
                        placeholder="Pilih Sumber" />
                </td> -->
